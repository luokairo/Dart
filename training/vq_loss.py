...
from dart.training.discriminator_patchgan import NLayerDiscriminator as PatchGANDiscriminator
from dart.training.discriminator_stylegan import Discriminator as StyleGANDiscriminator
from dart.training.lpips import LPIPS
...
class VQLoss(nn.Module):
    ...
    def forward(self, codebook_loss, usages, inputs, reconstructions, optimizer_idx, global_step, last_layer=None,
        ...
        if optimizer_idx == 0:
            ...
            if global_step % log_every == 0:
                ...
                logger.info(f"(Generator) rec_loss: {rec_loss:.4f}, perceptual_loss: {p_loss:.4f}, "
                            f"vq_loss: {codebook_loss:.4f},"
                            f"codebook_usage: {usages:.4f}, generator_adv_loss: {generator_adv_loss:.4f}, "
